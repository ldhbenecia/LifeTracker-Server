        ...
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .requestMatchers("/.env.development").denyAll()
                    ...
                    // PHP 관련 취약점 경로들
                    .requestMatchers("/vendor/phpunit/**").denyAll()
                    .requestMatchers("/phpunit/**").denyAll()
                    .requestMatchers("/lib/phpunit/**").denyAll()
                    .requestMatchers("/tests/phpunit/**").denyAll()
                    .requestMatchers("/eval-stdin.php").denyAll()
                    .requestMatchers("/phpunit/eval-stdin.php").denyAll()
                    .requestMatchers("/index.php").denyAll()
                    .requestMatchers("/phpunit/index.php").denyAll()
                    // 일반적인 공격 경로들
