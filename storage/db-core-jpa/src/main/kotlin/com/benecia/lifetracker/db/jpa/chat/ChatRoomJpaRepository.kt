...
import com.benecia.lifetracker.chat.chatRoom.model.ChatRoomDetailProjection
...
interface ChatRoomJpaRepository : JpaRepository<ChatRoomEntity, Long> {
    ...
    @Query(
        """
    SELECT new com.benecia.lifetracker.chat.chatRoom.model.ChatRoomWithOpponent(
