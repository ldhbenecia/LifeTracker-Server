package com.benecia.lifetracker.db.chat

import com.benecia.lifetracker.chat.chatMessage.service.ChatCacheRepository
...
@Repository
class RedisChatCacheRepository(
    ...
    override fun saveToZSet(message: ChatMessage) {
    ...
    override fun findMessagesByTimestampBefore(
        roomId: String,
